...
**Bu bir devs komitesine adına yapılmış bir blockchainin basit bir modülüdür**. Bu proje **blokzincir mantığını**, **madencilik (Proof of Work) mekanizmasını**, **işlem doğrulama süreçlerini** ve **hashleme** yöntemlerini barındırır
...
|**`wallet.js`**|anahtar yönetim arayüzü |public ve private anahtarlarını üretmeye yarayan ve public keyi base 58 foratında adres üretimini sağlar
|**`gossip.js`**|peerlar arası veri dağıtım ağı|perrlar arasında webSocket ileçifyönlü veri akışını sağlayan sistemdir.
